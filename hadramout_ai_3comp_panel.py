...
OUTPUT = "hadramout_ai_3comp_20260924_12Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_ai_2026092412.npz")
    ...
    axes[0].text(0.015, 0.985,
                 "Window: 24 Sep 2026 12Z → 4 Oct 2026 12Z (10 days)\n"
                 "Cycle: 20260924/12Z — AI-GFS (GraphCast), complete run",
    ...
    fig.text(0.01, 0.003,
             ...
             "Method: Quantile Delta Mapping (Cannon et al. 2015) applied to NOAA AIGFS v1.0 (GraphCast) cycle 20260924/12Z "
