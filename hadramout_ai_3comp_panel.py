...
OUTPUT = "hadramout_ai_3comp_20260925_18Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_ai_2026092518.npz")
    ...
    axes[0].text(0.015, 0.985,
                 ...
                 "Cycle: 20260925/18Z — AI-GFS (GraphCast), complete run",
