...
OUTPUT = "hadramout_v17_3comp_20260924_00Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_2026092400.npz")
    ...
    axes[0].text(0.015, 0.985,
                 ...
                 "Cycle: 20260924/00Z — latest complete run",
    ...
    fig.text(0.01, 0.003,
             ...
             "Method: Quantile Delta Mapping (Cannon et al. 2015) applied to operational GFS v16.3 cycle 20260924/00Z "
    ...
    # ===== تقرير المحطات =====
    print(f"\n📊 النقاط المرجعية (دورة 24/00Z — سيناريو v17-HR1):")
    print("-" * 88)
