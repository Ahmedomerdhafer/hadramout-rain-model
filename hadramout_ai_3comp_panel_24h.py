...
OUTPUT = "hadramout_ai_3comp_24h_20260924_00Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_24h_ai_2026092400.npz")
    ...
    axes[0].text(0.015, 0.985,
                 ...
                 "Cycle: 20260924/00Z — AI-GFS (GraphCast), f024 final",
