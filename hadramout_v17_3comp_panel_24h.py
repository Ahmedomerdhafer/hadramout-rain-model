...
OUTPUT = "hadramout_v17_3comp_24h_20260924_00Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_24h_2026092400.npz")
    ...
    axes[0].text(0.015, 0.985,
                 "Window: next 24 h — 24 Sep 2026 00Z → 25 Sep 2026 00Z\n"
                 "Cycle: 20260924/00Z — latest cycle (f024 final)",
    ...
    # ===== تقرير المحطات =====
    print(f"\n📊 النقاط المرجعية (دورة 24/00Z — سيناريو v17-HR1 — نافذة 24 ساعة):")
    print("-" * 88)
