...
OUTPUT = "hadramout_v17_3comp_24h_20260924_12Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_24h_2026092412.npz")
    ...
    axes[0].text(0.015, 0.985,
                 "Window: next 24 h — 24 Sep 2026 12Z → 25 Sep 2026 12Z\n"
                 "Cycle: 20260924/12Z — latest cycle (f024 final)",
