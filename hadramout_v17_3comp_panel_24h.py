...
OUTPUT = "hadramout_v17_3comp_24h_20260925_18Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_24h_2026092518.npz")
    ...
    axes[0].text(0.015, 0.985,
                 ...
                 "Cycle: 20260925/18Z — latest cycle (f024 final)",
