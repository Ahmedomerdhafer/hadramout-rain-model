...
OUTPUT = "hadramout_v17_3comp_24h_20260924_18Z_panel.png"
...
def main():
    d = np.load("gfs_cache/v17replay/scenario_3comp_24h_2026092418.npz")
    ...
    axes[0].text(0.015, 0.985,
                 ...
                 "Cycle: 20260924/18Z — latest cycle (f024 final)",
